...
Targets:
- CPA alvo: obrigatoriamente menor que R$10
- ROAS alvo: maior que 10x
- CPC médio alvo: R$0,60

Interpretação:
- CPA <= R$10: esperado para branded
- CPA entre R$10 e R$15: alerta
- CPA > R$15: problema claro
- ROAS >= 10x: esperado para branded
...
Interpretação:
- CPA <= R$15: eficiente, candidato a escala
- CPA entre R$15 e R$25: aceitável, otimizar antes de escalar
- CPA > R$25: risco, revisar intenção/copy/landing
- CPA > R$30: crítico, isolar, reduzir ou negativar com cautela
- ROAS >= 3.5x: saudável
